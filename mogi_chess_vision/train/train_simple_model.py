...
if not args.use_sim:
    dataset = '../samples_simple'
else:
    dataset = '../samples_simple_sim'
...
if not args.use_sim:
    filepath = "model_simple.best.h5"
else:
    filepath = "model_simple_sim.best.h5"
...
if not args.use_sim:
    ...
    model.save("model_simple_sim.h5")
...
plt.legend()
if not args.use_sim:
    plt.savefig('model_training_simple')
else:
    plt.savefig('model_training_simple_sim')
